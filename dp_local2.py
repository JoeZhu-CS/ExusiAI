...
class DSLocalAndVoiceGen:
	...
	def text_generator(self,text_queue,is_audio_play_complete,is_text_generating_queue,dp2qt_queue,qt2dp_queue,message_queue):
			...
			if not self.is_use_ds_api:
				...
				try:
					headers = {
						...
						"Authorization": "Bearer sk-28ad65772d8e467a9df1e2d09276ad61"
					}
					response = requests.post("https://api.deepseek.com/chat/completions", headers=headers, json=data)
				except Exception:
