...
def change_gpt_weights(gpt_path):
    ...
    _=t2s_model.load_state_dict(dict_s1["weight"])
    if is_half == True:
...
cache= {}
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut, top_k=20, top_p=0.6, temperature=0.6, ref_free = False,speed=1,if_freeze=False,inp_refs=123):

    how_to_cut=i18n(how_to_cut)
