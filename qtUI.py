...
class ChatGUI(QWidget):
    ...
    def handle_response(self,response_text):
        ...
        self.current_index = 0
        self.chat_display.append("ExuaiAI：")
        self.timer.start(60)
    ...
    def handle_user_input(self):
        ...
        if (user_this_turn_input!='clr'
            and current_text!="AI思考中..."
            and current_text!="AI在整理语言..."):
        ...
        if (user_this_turn_input!='lan' and user_this_turn_input!='model'
            and user_this_turn_input!='clr'):     #判断是否显示的逻辑，比较笨的方法
            flag=True
